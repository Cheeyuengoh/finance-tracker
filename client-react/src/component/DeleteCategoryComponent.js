...
export default function DeleteCategoryComponent({ category, setData }) {
    ...
    async function handleSubmit(e) {
        ...
        async function deleteData() {
            try {
                const response = await fetch(process.env.REACT_APP_API_URI + "/api/category/delete", {
                    method: "POST",
                    credentials: "include",
                    headers: {
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        <Form.Group className="d-flex flex-column">
                            <Form.Text>Are you sure you want to delete this category?</Form.Text>
                            <Form.Text>Transaction Type: {category.type}</Form.Text>
                            <Form.Text>Category Name: {category.name}</Form.Text>
                        </Form.Group>
